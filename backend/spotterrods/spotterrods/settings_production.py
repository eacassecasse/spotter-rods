...
SESSION_COOKIE_DOMAIN = ENV.get('DRF_SESSION_COOKIE_DOMAIN', None)
CSRF_COOKIE_DOMAIN = ENV.get('DRF_CSRF_COOKIE_DOMAIN', None)
SESSION_COOKIE_SAMESITE = ENV.get('DRF_SESSION_COOKIE_SAMESITE', None)
CSRF_COOKIE_SAMESITE = ENV.get('DRF_CSRF_COOKIE_SAMESITE', None)
